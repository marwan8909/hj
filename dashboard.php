...
<body class="">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-success card-header-icon">
                  ...
                  <p class="card-category">Resellers</p>
 ...
 <form method="GET" action="searchadmin.php">
  <input type="text" placeholder="search by reseller n:" name="searchreseller"/>
...
// mysql connection
$hostname = "localhost";
$username = "id19913661_user2";
$password = "@Pass35eae123";
$dbname = "id19913661_name2";
