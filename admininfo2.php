...
<body class="">
  <div class="wrapper ">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="admininfo.php">Resellers Info</a>
          </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                ...
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons text-secondary">add</i>
                    <a href="adminkey.php">Register Reseller...</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Registered Resellers </h4>
    ...
    <tbody>
     ...
     <?php
$fetchqry = "SELECT * FROM `admin_profile`";
...
while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) { ?>
	   ...
	   <td><?php echo $row['id'];?></td>
        ...
        <td><?php echo $row['wallet'];?></td>
         <?php
      {
         echo "<td> <a href='addwallet.php?no=".$row['username']."'><button type='button' class='btn btn-success'>ADD$</button></a> </td>";
      }
      ?>
        
        	<?php
      {
         echo "<td> <a href='dltreseller.php?no=".$row['username']."'><button type='button' class='btn btn-danger'>Delete</button></a> </td>";
      }

      ?>
      <?php
      {
         echo "<td> <a href='banreseller.php?no=".$row['username']."'><button type='button' class='btn btn-danger'>Ban</button></a> </td>";
      }
      ?>
