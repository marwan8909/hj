...
while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) { ?>
	   ...
	   <td><?php echo $row['id'];?></td>
        ...
        <td><?php echo $row['wallet'];?></td>
        	...
        	<?php
      {
         echo "<td> <a href='dltreseller.php?no=".$row['email']."'><button type='button' class='btn btn-danger'>Delete</button></a> </td>";
      }

      ?>
      <?php
      {
         echo "<td> <a href='banreseller.php?no=".$row['email']."'><button type='button' class='btn btn-danger'>Ban</button></a> </td>";
      }
