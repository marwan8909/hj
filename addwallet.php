      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="adminkey.php">Resellers Info</a>
          </div>
          ...
          <div class="row">
            ...
            <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Reseller Information</h4>
			...
			<input id="submit" name="register" type="submit" class="ui fluid green button" value="Update">
			</form>
		</div>
...
$key=$_GET["no"];
{
        @mysqli_query($con,"UPDATE admin_profile SET wallet=null WHERE id = " . $key) ;
    }
