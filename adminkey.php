      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="adminkey.php">Register Reseller</a>
          </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-success card-header-icon">
                  ...
                  <p class="card-category">Total Resellers</p>
                ...
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons text-secondary">add</i>
                    <a href="adminkey.php">Add Reseller...</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Reseller Registration Form</h4>
                  <p class="card-category">Enter Reseller Information</p>
                </div>
                <div class="card-body">
			...
			<!--	<label for="lastname">Password</label> -->
				<input type="text" placeholder="Username..."  name='nam' data-required="true" data-type="name" data-error-message="Username is required" required>
		        	</div>
			
				<div class='row'>
			<!--	<label for="lastname">Password</label> -->
				<input type="text" placeholder="Email Address..."  name='emai' data-required="true" data-type="email" data-error-message="Email is required" required>
		        	</div>
		        	<div class='row'>
			<!--	<label for="lastname">Password</label> -->
				<input type="text" placeholder="Password..."  name='passwor' data-required="true" data-type="password" data-error-message="Password is required" required>
		        	</div>
				   	<div class='row'>
			<!--	<label for="lastname">Password</label> -->
				<input type="text" placeholder="Mobile Number..."  name='mobil' data-required="true" data-type="numner" data-error-message="Mobile n. is required" required>
		        	</div>
                        	
						<div class='row'>
			<!--	<label for="lastname">Password</label> -->
				<input type="text" placeholder="Wallet Balance..."  name='walle' data-required="true" data-type="number" data-error-message="Wallet Balance is required" required>
		        	</div>
...
$insertlol = mysqli_query($con, "INSERT INTO `admin_profile` (username, email, mobile, password, status, created_at, wallet) 
  VALUES ('$name', '$email', '$mlobile', '$password', '1', '$date', '$wallet')") or die(mysqli_error($con));
    }
if ($insertlol){
