...
// mysql connection
$hostname = "localhost";
$username = "id16580899_test12121";
$password = "MI3@&s\G0hT}kw}A";
$dbname = "id16580899_test1212";
...
// fetch records
$result = @mysqli_query($conn,"select * from `tokens` where `Username` like '%$key%'") or die("Error: " . mysqli_error($con));
